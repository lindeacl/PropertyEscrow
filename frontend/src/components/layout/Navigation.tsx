...
export const Navigation: React.FC<NavigationProps> = ({ isCollapsed, onToggleCollapse }) => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <nav className={`hidden md:flex flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 ${
