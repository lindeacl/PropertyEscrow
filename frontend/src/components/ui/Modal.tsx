    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        >
          ...
          {(title || showCloseButton) && (
            <div className="flex items-center justify-between p-6 border-b border-grey-200 dark:border-grey-700">
              ...
              {showCloseButton && (
                <button
                  onClick={onClose}
                  className="p-1 text-grey-400 hover:text-royal-500 dark:hover:text-royal-400 transition-colors rounded-xl hover:bg-grey-100 dark:hover:bg-grey-700"
          ...
          {/* Content */}
          <div className={`p-6 ${title || showCloseButton ? '' : 'pt-6'}`}>
            {children}
          </div>
